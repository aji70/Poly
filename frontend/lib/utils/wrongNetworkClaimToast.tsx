...
const WRONG_NETWORK_MSG =
  "Your wallet is on the wrong network. Switch to Polygon to claim your rewards.";

/**
 * Show a toast with a "Switch to Polygon" button when claim fails due to wrong network.
 * Call this instead of the generic error toast when contractGame is missing and user
 * is not on Polygon (chain 137).
 */
